...
export default function CustomNoRowsOverlay() {
  return (
    <StyledGridOverlay>
      ...
      >
        <circle cx={56} cy="55.5" r="55.5" fill="#6350FF" fillOpacity="0.1" />
        <rect
          x="29.3599"
          y="34.4102"
          width="56.98"
        ...
        <rect
          ...
          fill="white"
        />
        <circle cx="5.6802" cy="92.8706" r="1.48" fill="#F7CE00" />
        <circle cx="78.5698" cy="112.48" r="1.48" fill="#6E56CF" />
        <circle cx="106.32" cy="94.7206" r="3.33" fill="#F7CE00" />
        <circle cx="5.6801" cy="21.0898" r="3.33" fill="#6E56CF" />
        <circle cx="91.8899" cy="70.3001" r="2.22" fill="#6E56CF" />
        <g filter="url(#filter0_d_5951_39835)">
          <circle cx="96.3299" cy="17.7605" r="12.95" fill="#6E56CF" />
          <path
      ...
      <h6 className="MuiTypography-root MuiTypography-h6 css-140e02k">
        No Data
      </h6>
      <p className="MuiTypography-root MuiTypography-body1 css-ryye6h">
